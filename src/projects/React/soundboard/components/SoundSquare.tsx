import React, { useEffect, useMemo, useReducer, useRef, useState, type CSSProperties, type ReactNode } from "react";
...
const SoundSquare = ({sound, onReorder = () => {}, index}: SoundSquareProps) => {
    ...
    if (isPlaying) {     
        switch (channelState) {
            ...
            //playing
            case 1:
                className += ' hover:shadow hover:shadow-md shadow-gray-600 shadow shadow-sm'
                style = {
                    borderColor: color,
            ...
            //buffering
            case 3:
                className += ' hover:shadow hover:shadow-md shadow-gray-600 shadow shadow-sm opacity-60'
                style = {
                    borderColor: color,
                    backgroundColor: color
